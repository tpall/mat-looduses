...
- Juhuslike P väärtuste jaotus tuleneb [järgmisest seosest](https://stats.stackexchange.com/questions/10613/why-are-p-values-uniformly-distributed-under-the-null-hypothesis#10617), tingimusel kui T on juhuslik muutuja kumulatiivse jaotusega $F(T) \equiv Pr(T<t)$ kõigi t väärtuste korral ja F on pööratav:
...
- Me otsisime NCBI GEO andmebaasist andmesette kasutatdes otsingusõna "expression profiling by high throughput sequencing"
- Tulemuseks leidsime 13575 andmekogu, millest esimene publitseeriti 2017-06-19
